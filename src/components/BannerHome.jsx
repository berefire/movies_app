                            ...
                            <div className='container mx-auto'>
                                <div className='w-full absolute bottom-0 max-w-md px-3'>
                                    ...
                                    <Link to={"/"+data?.media_type+"/"+data.id}>
                                        <button className='bg-red-600 px-4 py-2 text-black font-bold rounded mt-4  hover:bg-gradient-to-l from-red-700 to-red-500 shadow-md transition-all hover:scale-105'>
                                            Play Now
                                        </button>
                                    </Link>
                                </div>  
